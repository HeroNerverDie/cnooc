...
window.setEmailContent = function () {
    ...
    var mocImplementation = _this.$store.getters.nebulogyForm.nebulogyForm.mocImplementationRequestBasicInfo;

    //邮件主题
    _this.$store.getters.nebulogyForm.nebulogyForm.emailContent.subject = "[" + mocImplementation.plant + "]" + mocImplementation.mocTitle;
