...
window.clickRowFunc = function(data){
  ...
  var url = ''
	_this.$request({
      ...
      window.setMocNumber(data.mocNumber, url)
      debugger
      _this.$store.getters.nebulogyForm.nebulogyForm.mocImplementationRequestBasicInfo.mocNumber = data.mocNumber;
      ...
      _this.$store.getters.nebulogyForm.nebulogyForm.mocImplementationRequestBasicInfo.confirmItem1 = data.plant;
      _this.$store.getters.nebulogyForm.nebulogyForm.mocImplementationRequestBasicInfo.confirmItem2 = data.mocTitle;
