...
window.loadMOCCategory = function (v) {
    ...
    if (_mocType == "MSMRMOC") {
        ...
        setTimeout(function () {
            ...
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.authorizedInstrumentEngineer = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._authorizedInstrumentEngineer = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.authorizedInstrumentEngineerId = "";
            ...
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._processEngineerTechnologist = "";

            _this.$refs.processSafetyPCRSpecialist.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.processSafetyPCRSpecialist = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._processSafetyPCRSpecialist = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.processSafetyPCRSpecialistId = "";

            _this.$refs.qmiSpecialist.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.qmiSpecialist = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._qmiSpecialist = "";
            ...
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.inspectionCorrosionMetallurgyPCRspecialist = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._inspectionCorrosionMetallurgyPCRspecialist = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.inspectionCorrosionMetallurgyPCRspecialistId = "";

            _this.$refs.processControl.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.processControl = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._processControl = "";
            ...
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._instrumentDCSOTSecurity = "";
            ...
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.nominatedEngineer = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._nominatedEngineer = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.nominatedEngineerId = "";

            _this.$refs.electrical.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.electrical = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._electrical = "";
            ...
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._civil = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.civilId = "";

            _this.$refs.rotatingEngineer.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.rotatingEngineer = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._rotatingEngineer = "";
            ...
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._fireFighting = "";

            _this.$refs.hse.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.hse = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._hse = "";

            _this.$refs.others.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.others = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._others = "";

            //隐藏一些字段“维修主任授权代理工程师选择”模块
            _this.$refs.hom.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.hom = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._hom = "";

            _this.$refs.projectHead.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.projectHead = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._projectHead = "";

            _this.$refs.emDelegatedEngineer.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.emDelegatedEngineer = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._emDelegatedEngineer = "";

            _this.$refs.nomineeProjectEngineer.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.nomineeProjectEngineer = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._nomineeProjectEngineer = "";

            _this.$refs.otherWorkParty.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.otherWorkParty = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._otherWorkParty = "";

            _this.$refs.operatingNominee.hide();
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.operatingNominee = "";
            //_this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow._operatingNominee = "";
...
window.selectUnit = function (v) {
    ...
    _this.$request({
        ...
        .then((res) => {
            ...
            //切换装置时，清空单元
            if (_this.getView() != "reSubmit" && _this.getView() == "launch") {
...
window.getTechnicalAssessmentApproval = function () {
    ...
    if (_mocType == "PMOC" || _mocType == "TMOC") {
        ...
        if (_this.$refs.instrumentDCSOTSecurityId.getValue() == "") {
            _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.instrumentDCSOTSecurity = "";
            _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.instrumentDCSOTSecurityId = "";
        }
        ...
        if (_this.$refs.rotatingEngineer.getValue() == "") {
            _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.rotatingEngineerId = "";
            _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.rotatingEngineerIdId = "";
        }
...
window.setEmailContent = function () {
    //邮件主题
    var _plant = _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.plant;
    var _title = _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.mocTitle;
    _this.$store.getters.nebulogyForm.nebulogyForm.emailContent.subject = "[" + _plant + "]" + _title;
}
...
window.submitCheck = function (arguments) {
    ...
    if (_this.getView() == "launch") {
        ...
        if (window.plant != _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.plant ||
            window.unit != _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.unit ||
            _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.mocNumber == "") {

            window.plant = _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.plant;
            window.unit = _this.$store.getters.nebulogyForm.nebulogyForm.mocApprovalWorkflow.unit;
            ...
            _this.$request({
                ...
                method: "post",
                data: { procSetId: _this.getUrlData("procSetId"), prefixFolio: "PC-" + window.plant + "-" + window.unit + "-" },
            }).then((res) => {
...
window.approvalCheck = function (actionName, arguments) {
    ...
    //拒绝 退回
    if ((actionName == "PA_JabilCancel" || actionName == "Reject") && _this.getView() != "reSubmit") {
        ...
        if (_mocType == "PMOC" ||
            ...
            if (_this.$refs.documentLIst.propertyAttr.editable == true) {
                ...
                if (_error == false) {
                    ...
                    if (lang == 'zh-CN') {
                        _index++;
                        msgList.push(_index + "、文档号或文档更新人请至少填写一项!");
                    } else {
                        _index++;
                        msgList.push(_index + "、Please fill in at least one of the following: Document No. or To Be Updated by.");
                    }
                }
    ...
    if (_this.getView() == "approval") {
        ...
        if (_mocType == "LSMOC") {
            ...
            if (_activitysDisplayName.includes("150") || _activitysDisplayName.includes("040") ||
                _activitysDisplayName.includes("160") || _activitysDisplayName.includes("001") ||
            ...
            if (_activitysDisplayName.includes("001")) {
                //设置非必填
                //_this.$refs.processSafetyPCRSpecialist.propertyAttr.required = false;
                //_this.$refs.inspectionCorrosionMetallurgyPCRspecialist.propertyAttr.required = false;
            ...
            if (_activitysDisplayName.includes("150") || _activitysDisplayName.includes("040") ||
                _activitysDisplayName.includes("160") || _activitysDisplayName.includes("001") ||
                _activitysDisplayName.includes("080") || _activitysDisplayName.includes("060")) {
                ////mocEngineeringAssessmentPMOC  写错了 是 LSMOC
                //_this.$refs.mocEngineeringAssessmentPMOC.propertyAttr.editable = true;
