debugger
this.$store.getters.nebulogyForm.nebulogyForm.approver=this.getAccount().employee.employeeNo;
...
if (window.currentNode == '010_Applicant confirmation' || window.currentNode == '重新提交' || window.currentNode == 'Start') {
...
// 退回与拒绝时必填
if(action.actionName == 'PA_ReturnOriginator'){
  let content = this.$refs.approverDesc.getValue();
  if(!content){
